      ...
      body: SafeArea(
        child: Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(image: NetworkImage("https://png.pngtree.com/thumb_back/fh260/back_our/20190614/ourmid/pngtree-fresh-and-simple-h5-background-app-guide-page-design-background-download-image_121781.jpg"),
            fit: BoxFit.cover)
            // gradient: LinearGradient(
            //   colors: [Colors.white, Color.fromARGB(255, 23, 160, 170)],
